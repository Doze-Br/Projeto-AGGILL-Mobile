...
namespace Mobile.Transações
{
    ...
    public partial class Mercado : ContentPage
    {
        public Mercado()
        {
            InitializeComponent();
        ...
        private void Abrir_BitcoinDolar(object sender, EventArgs e)
        {
            Device.BeginInvokeOnMainThread(async () =>
            {
                await AbrirUrl();
        ...
        private void Abrir_EthereumDolar(object sender, EventArgs e)
        {
            Device.BeginInvokeOnMainThread(async () =>
            {
                await AbrirUrl();
        ...
        private void AtualizarMercado(object sender, EventArgs e)
        {
            BitcoinGrafDolar.IsVisible = true;
            EthereumGrafDolar.IsVisible = true;
            DescBitcoinDolar.Text = "Clique no gráfico para acessar uma versão completa do gráfico Bitcoin/Ethereum no navegador";
            DescEthereumDolar.Text = "Clique no gráfico para acessar uma versão completa do gráfico Ethereum/Bitcoin no navegador";
        }
    }
}